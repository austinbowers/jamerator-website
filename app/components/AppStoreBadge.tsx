...
export function AppStoreBadge({ href, height = 56, onClick, style = {} }: AppStoreBadgeProps) {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 384 512" width={h * 0.52} height={h * 0.52} fill="var(--sage-400)" aria-hidden="true" style={{ flex: 'none', marginTop: -h * 0.04 }}>
      ...
      <span style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', color: 'var(--sage-400)', fontFamily: sysFont, lineHeight: 1, whiteSpace: 'nowrap', textAlign: 'left' }}>
